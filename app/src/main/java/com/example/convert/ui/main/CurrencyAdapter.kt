...
import com.example.convert.ui.extensions.basicDiffUtil
import com.example.convert.ui.extensions.inflate
import com.example.convert.ui.extensions.round
...
class CurrencyAdapter : RecyclerView.Adapter<CurrencyAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(currency: Currency) {
            ...
            currencyBrlTitle.text = currency.rates?.INR?.round(2).toString()
        }
        ...
        fun setAmounts(currency: Currency, amount: Int) {
            ...
            currencyBrlTitle.text = "${(amount.toDouble() * currency.rates?.INR!!).round(2)}"
        }
    }
}